  ...
  return (
    <div className="about-margin-item" id="about">
      ...
      <p className="about-para">
        ...
        contribute to my overall success as a developer. I Started off my
        self-learning journey with online tutorials Google, YouTube, etc and
        found it interesting and decided to take a step further and Enrolled in
        the GUVI IIT MADRAS Full Stack developer Nanodegree Program which
        involved extensive programming and real-world projects. Later, I learned
        about MERN Stack from Guvi and built some Websites.
      </p>
    </div>
  );
}
